...
<body>
        ...
        <div class="row gx-0 align-items-center">
            ...
            <div class="col-lg-5 px-5 text-end">
                <div class="h-100 d-inline-flex align-items-center">
                    <a class="text-white-50 ms-4" href="{{ url('/') }}"><i class="fab fa-facebook-f"></i></a>
                    <a class="text-white-50 ms-4" href="{{ url('/') }}"><i class="fab fa-twitter"></i></a>
                    <a class="text-white-50 ms-4" href="{{ url('/') }}"><i class="fab fa-linkedin-in"></i></a>
                    <a class="text-white-50 ms-4" href="{{ url('/') }}"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
        <a href="index.html" class="navbar-brand d-flex align-items-center">
            <h1 class="m-0"><img class="img-fluid me-3" src="{{ url('frontend') }}/img/icon/icon-02-primary.png"
                    alt="{{ url('/') }}">Insure</h1>
        </a>
        ...
        <a href="{{ url('/') }}" class="btn btn-primary px-3 d-none d-lg-block">Get A Quote</a>
    </nav>
    <!-- Navbar End -->
